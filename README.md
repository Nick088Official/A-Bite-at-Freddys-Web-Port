...
2. Inside that folder, make a new `TouchControls.js` file containing:
    ...
    */
    ...
    ```
3. In the `godot` folder, open `ABaF.html` with a text editor, and before the `</body>` tag, add: `<script type="text/javascript" src="/TouchControls/TouchControls.js"></script>`
